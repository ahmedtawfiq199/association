                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('menus.create') }}" class="btn btn-primary">{{ __('+ Add new') }}</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($menus as $menu)
                                        <tr >
                                            ...
                                            <td style="padding-top: 10px;">
                                                <form method="post" id="deleteprojectform" action="{{route('menus.destroy',$menu->id)}}">
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('menus.edit', $menu->id) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
