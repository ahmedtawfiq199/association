                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('sub-menus.create') }}" class="btn btn-primary">{{ __('+ Add new') }}</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($subMenus as $sub)
                                        <tr >
                                            ...
                                            <td style="padding-top: 10px;">
                                                <form method="post" id="deleteprojectform" action="{{route('sub-menus.destroy',$sub->id)}}">
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('sub-menus.edit', $sub->id) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <div class="profile-photo">
                                                <img src="{{ asset('storage/'.$menu->main_image) }}" width="100" class="img-fluid rounded-circle" alt="">
                                            </div>
                                            <h3 class="mt-4 mb-1">{{ $menu->title }}</h3>

                                            <ul class="list-group mb-3 list-group-flush">
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">{{ __('Sub Title: ') }}</span><strong>{{ $menu->sub_title }}</strong></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
