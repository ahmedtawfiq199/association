    ...
    <div class="col-xl-12 col-xxl-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="card-title">{{ __('Edit Specialty') }}</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" id="title" name="title" value="{{ old('title',$specialty->title) }}" required autofocus >
                            </div>
                        </div>
                        {{-- end project title --}}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" id="sub_title" name="sub_title" value="{{ old('sub_title',$specialty->sub_title) }}" >
                            </div>
                        </div>
                        {{-- end project title --}}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            @if($specialty->image)
                                <img src="{{ asset('storage/'.$specialty->image) }}" width="100" alt="{{ $specialty->title }}">
                            @endif
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="summernote" cols="30" rows="10">{{ old('description',$specialty->description) }}</textarea>
                            </div>
                        </div>
                        {{-- end project title --}}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            @foreach ($specialty->images as $gallery)
                                ...
                                <img src="{{ asset('storage/'.$gallery->image) }}" width="100" alt="{{ $specialty->title }}">
                            @endforeach
                            <div class="form-group fallback w-100">
